...
<div class="d-flex w-50 align-items-center text-black flex-column m-auto flex-wrap">
    ...
    <div class="d-flex w-100 flex-wrap justify-content-between">
        <a href="products.php?category=hovezi" class="btn btn-primary" style="height: 200px; width: 200px">
            <h4>Hovězí</h4>
            <img src="res/cow.png" height="150" width="150" alt="kráva">
        </a>
        <a href="products.php?category=veprove" class="btn btn-primary" style="height: 200px; width: 200px">
            <h4>Vepřové</h4>
            <img src="res/pig.png" height="150" width="150" alt="prase">
        </a>
        <a href="products.php?category=kruti" class="btn btn-primary" style="height: 200px; width: 200px">
            <h4>Krůtí</h4>
            <img src="res/turkey.png" height="150" width="150" alt="krůta">
        </a>
        <a href="products.php?category=zverinove" class="btn btn-primary" style="height: 200px; width: 200px">
            <h4>Zvěřinové</h4>
